...
from scapy.all import DNS, sniff, send, IP, UDP, DNSQR


PASSWORD = "mysecretpassword"
SECRET_KEY = hashlib.sha256(PASSWORD.encode()).digest()[:16]  # Derive a 128-bit key from the password
...
def send_secret_aes_mdns(secret_message):
    """
    ...
    encrypted = encrypt(secret_message, SECRET_KEY, Fixed_iv)
...
if __name__ == "__main__":
    ...
    send_secret_aes_mdns(SECRET)
    # send_secret_rsa_mdns(SECRET)